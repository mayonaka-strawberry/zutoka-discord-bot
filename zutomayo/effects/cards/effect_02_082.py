...
async def effect_02_082(
    ...
    if not player.hand:
        ...
        await engine._send_dm(
            player_index,
            content='**Effect (02-082):** You have no cards in hand. Effect fizzles.',
        )
        return
    ...
    selected = await engine._prompt_card_selection(
        player_index,
        player.hand,
        prompt_text='**Effect (02-082):** Choose a card from your hand to place at the bottom of your deck.',
    ...
    if selected is None:
        ...
        await engine._send_dm(
            player_index,
            content='**Effect (02-082):** No effect.',
        )
        return
    ...
    # Move selected card from hand to bottom of deck
