...
async def effect_03_090(
    ...
    if has_battle and attr == Attribute.FLAME:
        ...
        log.debug('[%s] %s: character is flame, attack bonus +30 (%d -> %d)', card_instance.card.effect, engine.player_label(player_index), old_bonus, engine.turn_state.attack_bonus[player_index])
    else:
