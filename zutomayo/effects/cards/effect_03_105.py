...
async def effect_03_105(engine: EffectEngine, game_state: GameState, player_index: int, card_instance: CardInstance) -> None:
    ...
    await engine.broadcast_reveal(
        ...
        '**Effect (03-105):** Revealed card:',
        f'**Effect (03-105):** Your card was revealed: {revealed_name}.',
        owner_embed=embed,
        channel_message=f"**Effect (03-105):** A card was revealed from opponent's hand: {revealed_name}.",
    )
