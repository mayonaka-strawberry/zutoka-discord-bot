...
async def effect_03_089(
    engine: EffectEngine, game_state: GameState, player_index: int, card_instance: CardInstance,
) -> None:
    """Attack +50 if your character card's attribute is darkness."""
    ...
    if has_battle and attr == Attribute.DARKNESS:
        ...
        log.debug('[%s] %s: character is darkness, attack bonus +50 (%d -> %d)', card_instance.card.effect, engine.player_label(player_index), old_bonus, engine.turn_state.attack_bonus[player_index])
    else:
