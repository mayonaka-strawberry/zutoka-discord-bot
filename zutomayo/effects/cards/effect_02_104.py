...
async def effect_02_104(engine: EffectEngine, game_state: GameState, player_index: int, card_instance: CardInstance) -> None:
    """
    Attack +20 if your character card costs 2 or less.

    If your character card costs 4 or more, the area enchant is removed
